...
<el-table-column label="文章简介" style="width: 30%">
    <template slot-scope="scope">
            <span style="margin-left: 10px">{{ scope.row.brief }}</span>
        </template>
</el-table-column>
<el-table-column label="文章分类" style="width: 30%">
    <template slot-scope="scope">
            <span style="margin-left: 10px">{{ scope.row.category }}</span>
        </template>
</el-table-column>
<el-table-column label="操作" style="width: 10%" width="180">
    <template slot-scope="scope">
            <el-button
            size="mini"
...
<div class="pagination" style="margin-top:2rem">
    <el-pagination background :page-size='3' layout="prev, pager, next" @current-change='PageChange' :total="count">
    </el-pagination>
</div>
</div>
</template>
